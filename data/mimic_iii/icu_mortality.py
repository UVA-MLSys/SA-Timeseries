...
def main(sqluser, sqlpass):
  ...
  mimicdir = '../../dataset/mimic_iii'
  if not os.path.exists(mimicdir):
    os.makedirs(mimicdir, exist_ok=True)
...
if __name__=="__main__":
  ...
  parser.add_argument('--sqluser',type=str, default='postgres' ,help='postgres user to access mimic database')
  parser.add_argument('--sqlpass',type=str , default='postgres', help='postgres user password to access mimic database')
